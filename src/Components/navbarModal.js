        ...
        <div>
          ...
          <div className='modal-body'>
            <div className='link-section'>
              <Link to="/" className='first-link'><h6>HOME</h6></Link>
              <Link to="/products" className='second-link'><h6>PRODUCTS</h6></Link>
              <Link to="/about" className='third-link'><h6>ABOUT</h6></Link>
              <Link to="/account" className='fourth-link'><h6>ACCOUNT</h6></Link>
            </div>
